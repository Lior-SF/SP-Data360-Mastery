...
- **Reconciliation decides the unified-profile value** [src](https://help.salesforce.com/s/articleView?id=data.c360_a_reconciliation_rules.htm&release=264.0.0&type=5). Inference: that is the value targeting reads on a unified root:

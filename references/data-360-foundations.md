...
| 3. Identity rows present | QA3, QA4, Q10a in [sql-cookbook.md](sql-cookbook.md) | Name/Type pairs equal the rule's values on both sides; every row has an Individual |
